...
| 빠른 탐색/리서치 | `openai/gpt-5.3-codex` | ctf-explore, ctf-research, ctf-forensics, ctf-decoy-check, bounty-research, md-scribe |
| 깊은 사고/계획 | `openai/gpt-5.3-codex` | aegis-plan, ctf-hypothesis, deep-plan |
| 폴백 (explore) | `openai/gpt-5.3-codex` | explore-fallback |
| 폴백 (librarian/oracle) | `openai/gpt-5.3-codex` | librarian-fallback, oracle-fallback |
