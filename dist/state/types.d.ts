...
export declare const INTENT_TYPES: readonly ["research", "implement", "investigate", "evaluate", "fix", "unknown"];
export type IntentType = (typeof INTENT_TYPES)[number];
export declare const PROBLEM_STATE_CLASSES: readonly ["clean", "deceptive", "environment_sensitive", "evidence_poor", "unknown"];
